...
<div id="calendar_modal_background"></div>
 ...
 <div id="calendarInsert_modal_contents" class="calendar-contents-wrapper">
		...
		<div class="calendar-main-withdrawal-wrapper">
			<span id='insertCancelKanBan' class="calendar-main-withdrawal-btn"onclick="document.getElementById('calendarInsert_modal_contents').style.display='none'">&times;</span>
		</div>
		
		<!-- calendarEdit btn -->
		<div class="calendar-btn-wrapper">
			<button class="calendar-btn" id="insertCalendarKanBan" 
...
<!-- 			<button id="editCancel" class="calendar-main-withdrawal-btn"
			...
			<span id='editCancelKanBan' class="calendar-main-withdrawal-btn"onclick="document.getElementById('calendarEdit_modal_contents').style.display='none'">&times;</span>
		</div>
		...
		<!-- calendarEdit btn -->
		<div class="calendar-btn-wrapper">
			<button class="calendar-btn" id="editCalendarKanBan">수정</button>
		</div>
		<div class="calendar-btn-wrapper" id="okeditCalendarDiv"style="display:none;">
			<button class="calendar-btn" id="okeditCalendarKanBan"
